...
public class FileTreeModel implements TreeModel {
    ...
    public FileTreeModel(String rootDir) {
        ...
        //Khoi tao cay
        buildDerectoyTree(rootNode, rootDir);
        tree = new DefaultTreeModel(rootNode);
//        
    }
    //Tao cay thu muc 
    public void buildDerectoyTree(DefaultMutableTreeNode node,
                                        String rootDir){
        ...
        for(int i = 0; i < list.length; i++){
            ...
            node.add(child); 
            buildDerectoyTree(child, rootDir + File.separator + list[i].getName());
        }
    }
